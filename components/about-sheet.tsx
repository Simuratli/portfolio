  ...
  return (
    <Sheet open={open} onOpenChange={onOpenChange}>
      ...
      >
        ...
        <SheetDescription className="sr-only">Front-end developer based in Baku, Azerbaijan.</SheetDescription>
        ...
        <div className="flex flex-col gap-6">
          ...
          <p className="text-2xl text-gray-800 leading-relaxed font-normal">
            I&apos;ve spent my career building polished interfaces and I absolutely love it.
            The craft of turning design into pixel-perfect, performant code is what drives me.
          </p>
        </div>

        {/* Section */}
        <div className="flex flex-col gap-3 pt-4 border-t border-gray-100">
          <h3 className="text-xl font-semibold text-gray-900">Building Delightful Experiences</h3>
          <p className="text-base text-gray-500 leading-relaxed">
            I thrive on creating interfaces that make a difference. Whether it&apos;s collaborating
            with teams or working solo, my goal is to make user experiences fast,
        ...
        <div className="flex flex-col gap-4 pt-4 border-t border-gray-100">
          <h3 className="text-xs font-semibold tracking-widest text-gray-400 uppercase">Stack</h3>
          <div className="flex flex-wrap gap-2">
            {["React", "Next.js", "TypeScript", "Tailwind CSS", "Framer Motion", "Node.js"].map((tech) => (
              <span
                key={tech}
        ...
        {/* Contact */}
        <div className="flex flex-col gap-3 pt-4 border-t border-gray-100">
          <h3 className="text-xs font-semibold tracking-widest text-gray-400 uppercase">Contact</h3>
          {[
